...
#define MAX_NUMBER_OF_POKEMON 20
...
class Selection2:public Menu{
	...
	public:
		Selection2(float width, float height):Menu(width, height){
			...
			menu[0].setPosition(sf::Vector2f(1200, height / (MAX_NUMBER_OF_POKEMON+6)*1));
			...
			menu[1].setPosition(sf::Vector2f(1200, height / (MAX_NUMBER_OF_POKEMON+6)*2));
			...
			menu[2].setPosition(sf::Vector2f(1200, height / (MAX_NUMBER_OF_POKEMON+6)*3));
			...
			menu[3].setPosition(sf::Vector2f(1200, height / (MAX_NUMBER_OF_POKEMON+6)*4));
