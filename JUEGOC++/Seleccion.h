...
class Selection:public Menu{
	...
	public:
		Selection(float width, float height):Menu(width, height){
			...
			menu[0].setPosition(sf::Vector2f(600, height / (MAX_NUMBER_OF_POKEMON+6)*1));
			...
			menu[1].setPosition(sf::Vector2f(600, height / (MAX_NUMBER_OF_POKEMON+6)*2));
			...
			menu[2].setPosition(sf::Vector2f(600, height / (MAX_NUMBER_OF_POKEMON+6)*3));
			...
			menu[3].setPosition(sf::Vector2f(600, height / (MAX_NUMBER_OF_POKEMON+6)*4));
